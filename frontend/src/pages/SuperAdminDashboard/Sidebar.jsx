  ...
  return (
    ...
    <SidebarNav>
      <SidebarNavItem>
        ...
        <StyledLink to="/super-admin/dashboard">Dashboard</StyledLink>
      </SidebarNavItem>
        <SidebarNavItem>
        ...
        <SidebarNavItem>
          <SidebarIcon><BsPeople /></SidebarIcon>
          <StyledLink to="/super-admin/intergration-options">Intergration Options</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsPerson /></SidebarIcon>
          <StyledLink to="/super-admin/schools">Schools</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
